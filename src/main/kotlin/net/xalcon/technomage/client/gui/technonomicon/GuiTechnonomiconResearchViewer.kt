...
class GuiTechnonomiconResearchViewer : GuiScreen()
{
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float)
    {
        ...
        val relMousePos = Vec2f(relMouseX.toFloat(), relMouseY.toFloat())
        ...
        this.pageList[0].renderView(viewport, zoom, relMousePos)
        ...
        this.drawBorder()
        //GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f)
        this.pageList[0].handleMouseOver(viewport, zoom, relMousePos)
